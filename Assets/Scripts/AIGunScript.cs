...
public class AIGunScript : MonoBehaviour
{
    ...
    {
        // if (other.gameObject.tag == "Player" || other.gameObject.tag == "Computer" )
        // {
        //     if (other.gameObject != gameObj)
        //     {
        //         other.gameObject.GetComponent<AIScript>().HitGun();
        //     }
        //     playerScript.availableGunNum++;
        //     Destroy(this.gameObject);
        // }
